	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 appendResult939_g232 = (float3(0.0 , 0.0 , saturate( inputMesh.positionOS ).z));
				float3 break989_g232 = inputMesh.positionOS;
				float3 appendResult938_g232 = (float3(break989_g232.x , ( break989_g232.y * 0.15 ) , 0.0));
				float mulTime975_g232 = _TimeParameters.x * 2.1;
				float3 temp_output_624_0_g232 = ( ( inputMesh.positionOS - float3(0,-1,0) ) / _Radius );
				float dotResult625_g232 = dot( temp_output_624_0_g232 , temp_output_624_0_g232 );
				float temp_output_628_0_g232 = pow( saturate( dotResult625_g232 ) , _Hardness );
				float SphearicalMaskCM763_g232 = saturate( temp_output_628_0_g232 );
				float3 temp_cast_0 = (inputMesh.positionOS.y).xxx;
				float2 appendResult928_g232 = (float2(inputMesh.positionOS.x , inputMesh.positionOS.z));
				float3 temp_output_996_0_g232 = ( cross( temp_cast_0 , float3( appendResult928_g232 ,  0.0 ) ) * 0.005 );
				float3 appendResult931_g232 = (float3(0.0 , inputMesh.positionOS.y , 0.0));
				float3 break971_g232 = inputMesh.positionOS;
				float3 appendResult967_g232 = (float3(break971_g232.x , 0.0 , ( break971_g232.z * 0.15 )));
				float mulTime976_g232 = _TimeParameters.x * 2.3;
				float dotResult849_g232 = dot( (inputMesh.positionOS*0.02 + 0.0) , inputMesh.positionOS );
				float CenterOfMassThicknessMask854_g232 = saturate( dotResult849_g232 );
				float3 appendResult981_g232 = (float3(inputMesh.positionOS.x , 0.0 , 0.0));
				float3 break984_g232 = inputMesh.positionOS;
				float3 appendResult966_g232 = (float3(0.0 , ( break984_g232.y * 0.2 ) , ( break984_g232.z * 0.4 )));
				float mulTime977_g232 = _TimeParameters.x * 2.0;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float3 normalizeResult765_g232 = normalize( ase_worldPos );
				float mulTime772_g232 = _TimeParameters.x * 0.25;
				float simplePerlin2D769_g232 = snoise( ( normalizeResult765_g232 + mulTime772_g232 ).xy*0.43 );
				float WindMask_LargeB770_g232 = ( simplePerlin2D769_g232 * 1.5 );
				float3 normalizeResult1092_g232 = normalize( inputMesh.positionOS );
				float CenterOfMassTrunkUP_C1098_g232 = saturate( distance( normalizeResult1092_g232 , float3(0,1,0) ) );
				float3 normalizeResult774_g232 = normalize( ase_worldPos );
				float mulTime780_g232 = _TimeParameters.x * 0.26;
				float simplePerlin2D778_g232 = snoise( ( normalizeResult774_g232 + mulTime780_g232 ).xy*0.7 );
				float WindMask_LargeC779_g232 = ( simplePerlin2D778_g232 * 1.5 );
				float mulTime906_g232 = _TimeParameters.x * 3.2;
				float3 worldToObj907_g232 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(inputMesh.positionOS), 1 ) ).xyz;
				float3 temp_output_872_0_g232 = ( mulTime906_g232 + ( 0.02 * worldToObj907_g232.x ) + ( worldToObj907_g232.y * 0.14 ) + ( worldToObj907_g232.z * 0.16 ) + float3(0.4,0.3,0.1) );
				float3 normalizeResult632_g232 = normalize( inputMesh.positionOS );
				float CenterOfMassTrunkUP636_g232 = saturate( (distance( normalizeResult632_g232 , float3(0,1,0) )*1.0 + -0.05) );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float mulTime905_g232 = _TimeParameters.x * 2.3;
				float3 worldToObj908_g232 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(inputMesh.positionOS), 1 ) ).xyz;
				float3 temp_output_866_0_g232 = ( mulTime905_g232 + ( 0.2 * worldToObj908_g232 ) + float3(0.4,0.3,0.1) );
				float mulTime904_g232 = _TimeParameters.x * 3.6;
				float3 temp_cast_4 = (inputMesh.positionOS.x).xxx;
				float3 worldToObj910_g232 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(temp_cast_4), 1 ) ).xyz;
				float temp_output_898_0_g232 = ( mulTime904_g232 + ( 0.2 * worldToObj910_g232.x ) );
				float3 normalizeResult697_g232 = normalize( inputMesh.positionOS );
				float CenterOfMass701_g232 = saturate( (distance( normalizeResult697_g232 , float3(0,1,0) )*2.0 + 0.0) );
				float SphericalMaskProxySphere704_g232 = (( _CenterofMass )?( ( temp_output_628_0_g232 * CenterOfMass701_g232 ) ):( temp_output_628_0_g232 ));
				float3 worldToObj1131_g232 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(inputMesh.positionOS), 1 ) ).xyz;
				float mulTime1138_g232 = _TimeParameters.x * 4.0;
				float mulTime1129_g232 = _TimeParameters.x * 0.2;
				float2 appendResult1126_g232 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 normalizeResult1128_g232 = normalize( appendResult1126_g232 );
				float simpleNoise1139_g232 = SimpleNoise( ( mulTime1129_g232 + normalizeResult1128_g232 )*1.0 );
				float WindMask_SimpleSway1145_g232 = ( ( simpleNoise1139_g232 * 1.5 ) * _PivotSwayPower );
				float3 rotatedValue1151_g232 = RotateAroundAxis( float3( 0,0,0 ), inputMesh.positionOS, normalize( float3(0.6,1,0.1) ), ( ( cos( ( ( worldToObj1131_g232 * 0.02 ) + mulTime1138_g232 + ( float3(0.6,1,0.8) * 0.3 * worldToObj1131_g232 ) ) ) * 0.1 ) * WindMask_SimpleSway1145_g232 * saturate( ase_objectScale ) ).x );
				float3 temp_cast_6 = (0.0).xxx;
				#if defined( _WINDTYPE_GENTLEBREEZE )
				float3 staticSwitch1044_g232 = ( ( ( ( ( ( ( ( ( appendResult939_g232 + ( appendResult938_g232 * cos( mulTime975_g232 ) ) + ( cross( float3(1.2,0.6,1) , ( appendResult938_g232 * float3(0.7,1,0.8) ) ) * sin( mulTime975_g232 ) ) ) * SphearicalMaskCM763_g232 * temp_output_996_0_g232 ) * 0.08 ) + ( ( ( appendResult931_g232 + ( appendResult967_g232 * cos( mulTime976_g232 ) ) + ( cross( float3(0.9,1,1.2) , ( appendResult967_g232 * float3(1,1,1) ) ) * sin( mulTime976_g232 ) ) ) * SphearicalMaskCM763_g232 * CenterOfMassThicknessMask854_g232 * temp_output_996_0_g232 ) * 0.1 ) + ( ( ( appendResult981_g232 + ( appendResult966_g232 * cos( mulTime977_g232 ) ) + ( cross( float3(1.1,1.3,0.8) , ( appendResult966_g232 * float3(1.4,0.8,1.1) ) ) * sin( mulTime977_g232 ) ) ) * SphearicalMaskCM763_g232 * temp_output_996_0_g232 ) * 0.05 ) ) * _BranchWindLarge ) * WindMask_LargeB770_g232 ) * CenterOfMassTrunkUP_C1098_g232 ) + ( ( ( WindMask_LargeC779_g232 * ( ( ( ( cos( temp_output_872_0_g232 ) * sin( temp_output_872_0_g232 ) * CenterOfMassTrunkUP636_g232 * SphearicalMaskCM763_g232 * CenterOfMassThicknessMask854_g232 * saturate( ase_objectScale ) ) * 0.2 ) + ( ( cos( temp_output_866_0_g232 ) * sin( temp_output_866_0_g232 ) * CenterOfMassTrunkUP636_g232 * CenterOfMassThicknessMask854_g232 * SphearicalMaskCM763_g232 * saturate( ase_objectScale ) ) * 0.2 ) + ( ( sin( temp_output_898_0_g232 ) * cos( temp_output_898_0_g232 ) * SphericalMaskProxySphere704_g232 * CenterOfMassThicknessMask854_g232 * CenterOfMassTrunkUP636_g232 ) * 0.2 ) ) * _BranchWindSmall ) ) * 0.3 ) * CenterOfMassTrunkUP_C1098_g232 ) + (( _PivotSway )?( ( ( rotatedValue1151_g232 - inputMesh.positionOS ) * 0.4 ) ):( float3( 0,0,0 ) )) ) * saturate( inputMesh.positionOS.y ) );
				#elif defined( _WINDTYPE_WINDOFF )
				float3 staticSwitch1044_g232 = temp_cast_6;
				#else
				float3 staticSwitch1044_g232 = ( ( ( ( ( ( ( ( ( appendResult939_g232 + ( appendResult938_g232 * cos( mulTime975_g232 ) ) + ( cross( float3(1.2,0.6,1) , ( appendResult938_g232 * float3(0.7,1,0.8) ) ) * sin( mulTime975_g232 ) ) ) * SphearicalMaskCM763_g232 * temp_output_996_0_g232 ) * 0.08 ) + ( ( ( appendResult931_g232 + ( appendResult967_g232 * cos( mulTime976_g232 ) ) + ( cross( float3(0.9,1,1.2) , ( appendResult967_g232 * float3(1,1,1) ) ) * sin( mulTime976_g232 ) ) ) * SphearicalMaskCM763_g232 * CenterOfMassThicknessMask854_g232 * temp_output_996_0_g232 ) * 0.1 ) + ( ( ( appendResult981_g232 + ( appendResult966_g232 * cos( mulTime977_g232 ) ) + ( cross( float3(1.1,1.3,0.8) , ( appendResult966_g232 * float3(1.4,0.8,1.1) ) ) * sin( mulTime977_g232 ) ) ) * SphearicalMaskCM763_g232 * temp_output_996_0_g232 ) * 0.05 ) ) * _BranchWindLarge ) * WindMask_LargeB770_g232 ) * CenterOfMassTrunkUP_C1098_g232 ) + ( ( ( WindMask_LargeC779_g232 * ( ( ( ( cos( temp_output_872_0_g232 ) * sin( temp_output_872_0_g232 ) * CenterOfMassTrunkUP636_g232 * SphearicalMaskCM763_g232 * CenterOfMassThicknessMask854_g232 * saturate( ase_objectScale ) ) * 0.2 ) + ( ( cos( temp_output_866_0_g232 ) * sin( temp_output_866_0_g232 ) * CenterOfMassTrunkUP636_g232 * CenterOfMassThicknessMask854_g232 * SphearicalMaskCM763_g232 * saturate( ase_objectScale ) ) * 0.2 ) + ( ( sin( temp_output_898_0_g232 ) * cos( temp_output_898_0_g232 ) * SphericalMaskProxySphere704_g232 * CenterOfMassThicknessMask854_g232 * CenterOfMassTrunkUP636_g232 ) * 0.2 ) ) * _BranchWindSmall ) ) * 0.3 ) * CenterOfMassTrunkUP_C1098_g232 ) + (( _PivotSway )?( ( ( rotatedValue1151_g232 - inputMesh.positionOS ) * 0.4 ) ):( float3( 0,0,0 ) )) ) * saturate( inputMesh.positionOS.y ) );
				#endif
				float3 FinalWind_Output1060_g232 = ( _GlobalWindStrength * staticSwitch1044_g232 );
				...
				#endif
				float3 vertexValue = FinalWind_Output1060_g232;
						...
						)
			{
				...
				float2 texCoord18_g233 = packedInput.ase_texcoord5.xy * _Tiling + _Offset;
				
				float3 unpack7_g233 = UnpackNormalScale( tex2D( _NormalMap, texCoord18_g233 ), _NormalIntensity );
				unpack7_g233.z = lerp( 1, unpack7_g233.z, saturate(_NormalIntensity) );
				
				float4 tex2DNode11_g233 = tex2D( _MaskMap, texCoord18_g233 );
				
				float saferPower25_g233 = abs( tex2DNode11_g233.g );
				
				surfaceDescription.BaseColor = tex2D( _AlbedoMap, texCoord18_g233 ).rgb;
				surfaceDescription.Normal = unpack7_g233;
				...
				surfaceDescription.Smoothness = ( tex2DNode11_g233.a * _Smoothnessintensity );
				surfaceDescription.Occlusion = pow( saferPower25_g233 , _Aointensity );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord18_g233 = packedInput.ase_texcoord2.xy * _Tiling + _Offset;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord18_g233 = packedInput.ase_texcoord3.xy * _Tiling + _Offset;
				float3 unpack7_g233 = UnpackNormalScale( tex2D( _NormalMap, texCoord18_g233 ), _NormalIntensity );
				unpack7_g233.z = lerp( 1, unpack7_g233.z, saturate(_NormalIntensity) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord18_g233 = packedInput.ase_texcoord7.xy * _Tiling + _Offset;
...
/*ASEBEGIN
Version=19501
Node;AmplifyShaderEditor.FunctionNode;2697;-240,224;Inherit;False;(TTFE) Tree Bark_Wind System;9;;232;58360699feb112c40b86ba9ba75062e6;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;2698;-240,48;Inherit;False;(TTFE) Tree Bark_Shading;0;;233;07105d68e42fa94479944563340e838c;0;0;4;COLOR;0;FLOAT3;12;FLOAT;13;FLOAT;14
...
WireConnection;2676;0;2698;0
WireConnection;2676;1;2698;12
WireConnection;2676;7;2698;13
WireConnection;2676;8;2698;14
WireConnection;2676;11;2697;0
ASEEND*/
//CHKSM=054371C78331C2DABCD26DE6DA18260901B3A8C6