...
Shader "Toby Fredson/The Toby Foliage Engine/(TTFE) Mesh"
{
	Properties
	{
		...
		[Header(__________(TTFE) MESH SHADER___________)][Header(_____________________________________________________)][Header(Texture Maps)]_AlbedoMap("Albedo Map", 2D) = "white" {}
...
WireConnection;127;8;3;2
ASEEND*/
//CHKSM=96D8A541BA147C105C6A1CCB4880077AD4B553AD