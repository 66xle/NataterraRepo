	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult87_g3 = (float4(cross( inputMesh.normalOS , float3(0,0,1) ) , -1.0));
				...
				inputMesh.tangentOS = appendResult87_g3;
						...
						)
			{
				...
				float4 tex2DNode2_g3 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex );
				float3 lerpResult61_g3 = lerp( (_Color).rgb , (tex2DNode2_g3).rgb , 1.0);
				
				float2 uv_MetallicTex = packedInput.ase_texcoord5.xy * _MetallicTex_ST.xy + _MetallicTex_ST.zw;
				
				surfaceDescription.BaseColor = lerpResult61_g3;
				...
				surfaceDescription.Smoothness = tex2DNode2_g3.a;
...
/*ASEBEGIN
Version=19501
Node;AmplifyShaderEditor.FunctionNode;1341;1968,-896;Inherit;False;(TTFE) Terrain 8 Layer BasePass;0;;3;4303f64a9085c274597c3144b2a0158a;0;0;5;FLOAT3;58;FLOAT;51;FLOAT;52;FLOAT3;92;FLOAT4;93
...
WireConnection;1327;0;1341;58
WireConnection;1327;4;1341;51
WireConnection;1327;7;1341;52
WireConnection;1327;12;1341;92
WireConnection;1327;27;1341;93
ASEEND*/
//CHKSM=7856E842872262E50F28F69CB44874D0014E3F01