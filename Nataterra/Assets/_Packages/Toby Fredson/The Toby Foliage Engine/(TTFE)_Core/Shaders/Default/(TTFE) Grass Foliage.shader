...
Shader "Toby Fredson/The Toby Foliage Engine/(TTFE) Grass Foliage"
{
	Properties
	{
		...
		[Header((Normal))]_NormalIntensity("Normal Intensity", Range( -10 , 10)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float mulTime1140_g2145 = _TimeParameters.x * 1.5;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 appendResult1144_g2145 = (float2(ase_worldPos.x , ase_worldPos.z));
				float simpleNoise1079_g2145 = SimpleNoise( ( ( (0) * mulTime1140_g2145 ) + appendResult1144_g2145 )*4.0 );
				float simpleNoise1077_g2145 = SimpleNoise( ( ( (0) * _TimeParameters.x ) + appendResult1144_g2145 ) );
				float temp_output_1083_0_g2145 = ( (simpleNoise1077_g2145*2.2 + -1.05) * 1.6 );
				float3 temp_output_1094_0_g2145 = ( inputMesh.positionOS * 0.3 );
				float3 NormaliseRotationAxis1168_g2145 = float3(0,1,0);
				float simplePerlin2D1090_g2145 = snoise( ( ase_worldPos + ( _TimeParameters.z * 1.5 ) ).xy*1.2 );
				simplePerlin2D1090_g2145 = simplePerlin2D1090_g2145*0.5 + 0.5;
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float3 clampResult1155_g2145 = clamp( (ase_objectScale*1.8 + -0.8) , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float3 Scale_MaskB1165_g2145 = clampResult1155_g2145;
				float3 rotatedValue1093_g2145 = RotateAroundAxis( float3( 0,0,0 ), temp_output_1094_0_g2145, NormaliseRotationAxis1168_g2145, ( simplePerlin2D1090_g2145 * 1.0 * Scale_MaskB1165_g2145 ).x );
				float3 worldToObjDir1125_g2145 = mul( GetWorldToObjectMatrix(), float4( ( ( (simpleNoise1079_g2145*3.09 + -1.5) * 1.6 ) * temp_output_1083_0_g2145 * ( temp_output_1083_0_g2145 * ( temp_output_1094_0_g2145 - rotatedValue1093_g2145 ) ) * sin( _TimeParameters.x * 0.125 ) * inputMesh.positionOS.y ), 0 ) ).xyz;
				float2 appendResult1154_g2145 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 BasicWindPositionAndTime1151_g2145 = ( appendResult1154_g2145 + _TimeParameters.x );
				float simplePerlin2D1177_g2145 = snoise( BasicWindPositionAndTime1151_g2145*0.6 );
				simplePerlin2D1177_g2145 = simplePerlin2D1177_g2145*0.5 + 0.5;
				float NoiseLarge1179_g2145 = simplePerlin2D1177_g2145;
				float mulTime1100_g2145 = _TimeParameters.x * 2.0;
				float3 rotatedValue1109_g2145 = RotateAroundAxis( ( saturate( inputMesh.positionOS.y ) * inputMesh.positionOS ), ( cos( ( ( ase_worldPos * 0.2 ) + mulTime1100_g2145 ) ) * inputMesh.positionOS.y * float3(0.5,0.05,0.5) * _GrassSwayPowerPerMaterial ), NormaliseRotationAxis1168_g2145, NoiseLarge1179_g2145 );
				float3 worldToObjDir1112_g2145 = mul( GetWorldToObjectMatrix(), float4( rotatedValue1109_g2145, 0 ) ).xyz;
				float3 clampResult1161_g2145 = clamp( (ase_objectScale*1.0 + -0.6) , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float3 Scale_MaskA1164_g2145 = clampResult1161_g2145;
				float simplePerlin2D1170_g2145 = snoise( BasicWindPositionAndTime1151_g2145*0.1 );
				float MaskRotation1174_g2145 = saturate( simplePerlin2D1170_g2145 );
				float3 clampResult1157_g2145 = clamp( (ase_objectScale*-0.7 + 2.2) , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float3 Scale_MaskC1166_g2145 = clampResult1157_g2145;
				float simplePerlin2D1172_g2145 = snoise( BasicWindPositionAndTime1151_g2145*0.09995 );
				simplePerlin2D1172_g2145 = simplePerlin2D1172_g2145*0.5 + 0.5;
				float MaskRotation21175_g2145 = saturate( simplePerlin2D1172_g2145 );
				float StrongWindSpeed1194_g2145 = _StrongWindSpeed;
				float3 temp_output_1120_0_g2145 = ( inputMesh.positionOS * 0.2 );
				float3 rotatedValue1121_g2145 = RotateAroundAxis( float3( 0,0,0 ), temp_output_1120_0_g2145, NormaliseRotationAxis1168_g2145, ( ( NoiseLarge1179_g2145 * StrongWindSpeed1194_g2145 ) * inputMesh.positionOS.y * Scale_MaskC1166_g2145 * Scale_MaskB1165_g2145 ).x );
				float3 worldToObjDir1130_g2145 = mul( GetWorldToObjectMatrix(), float4( ( rotatedValue1121_g2145 - temp_output_1120_0_g2145 ), 0 ) ).xyz;
				#ifdef _CONTINUOUSWINDGENTLE_ON
				float3 staticSwitch1136_g2145 = worldToObjDir1130_g2145;
				#else
				float3 staticSwitch1136_g2145 = ( MaskRotation21175_g2145 * worldToObjDir1130_g2145 );
				#endif
				float3 temp_cast_3 = (0.0).xxx;
				#if defined( _WINDTYPE_GENTLEBREEZE )
				float3 staticSwitch1183_g2145 = (float3( 0,0,0 ) + (( ( worldToObjDir1125_g2145 - ( worldToObjDir1112_g2145 * inputMesh.positionOS.y * Scale_MaskA1164_g2145 * MaskRotation1174_g2145 * Scale_MaskC1166_g2145 ) ) + staticSwitch1136_g2145 ) - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( 0,0,0 )) / (float3( 1,1,1 ) - float3( 0,0,0 )));
				#elif defined( _WINDTYPE_WINDOFF )
				float3 staticSwitch1183_g2145 = temp_cast_3;
				#else
				float3 staticSwitch1183_g2145 = (float3( 0,0,0 ) + (( ( worldToObjDir1125_g2145 - ( worldToObjDir1112_g2145 * inputMesh.positionOS.y * Scale_MaskA1164_g2145 * MaskRotation1174_g2145 * Scale_MaskC1166_g2145 ) ) + staticSwitch1136_g2145 ) - float3( 0,0,0 )) * (float3( 1,1,1 ) - float3( 0,0,0 )) / (float3( 1,1,1 ) - float3( 0,0,0 )));
				#endif
				float3 FinalWind_Output1186_g2145 = ( _GlobalWindStrength * staticSwitch1183_g2145 );
				
				float3 LightDetectBackface_Output156_g2185 = (( _WorldUp )?( float3(0,1,0) ):( inputMesh.normalOS ));
				...
				#endif
				float3 vertexValue = FinalWind_Output1186_g2145;
				...
				inputMesh.normalOS = LightDetectBackface_Output156_g2185;
						...
						)
			{
				...
				float2 uv_AlbedoMap285_g2185 = packedInput.ase_texcoord5.xy;
				float2 uv_AlbedoMap295_g2185 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode295_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap295_g2185 );
				float2 uv_NoiseMapGrayscale302_g2185 = packedInput.ase_texcoord5.xy;
				float4 transform307_g2185 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform307_g2185.xyz = GetAbsolutePositionWS((transform307_g2185).xyz);
				float dotResult4_g2187 = dot( transform307_g2185.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2187 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2187 ) * 43758.55 ) ));
				float3 normalizeResult259_g2185 = normalize( packedInput.ase_texcoord6.xyz );
				float DryLeafPositionMask263_g2185 = ( (distance( normalizeResult259_g2185 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult294_g2185 = lerp( ( _DryLeafColor * ( tex2DNode295_g2185.g * 2 ) ) , tex2DNode295_g2185 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale302_g2185 ).r * lerpResult10_g2187 * DryLeafPositionMask263_g2185 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output311_g2185 = lerpResult294_g2185;
				Gradient gradient271_g2185 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float4 transform273_g2185 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform273_g2185.xyz = GetAbsolutePositionWS((transform273_g2185).xyz);
				float dotResult4_g2186 = dot( transform273_g2185.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2186 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2186 ) * 43758.55 ) ));
				float4 lerpResult282_g2185 = lerp( SeasonControl_Output311_g2185 , ( ( SeasonControl_Output311_g2185 * 0.5 ) + ( SampleGradient( gradient271_g2185, lerpResult10_g2186 ) * SeasonControl_Output311_g2185 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA313_g2185 = packedInput.ase_texcoord5.xy;
				float4 lerpResult283_g2185 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap285_g2185 ) , lerpResult282_g2185 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA313_g2185 ).r ):( 1.0 )));
				float4 GrassColorVariation_Output109_g2185 = lerpResult283_g2185;
				float4 transform392_g2185 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord6.xyz , 0.0 ));
				transform392_g2185.xyz = GetAbsolutePositionWS((transform392_g2185).xyz);
				float dotResult401_g2185 = dot( float4( V , 0.0 ) , -( float4( SafeNormalize(-_DirectionalLightDatas[0].forward) , 0.0 ) + ( (( _TranslucencyTreeTangents )?( float4( packedInput.ase_normal , 0.0 ) ):( transform392_g2185 )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA402_g2185 = packedInput.ase_texcoord5.xy;
				float TobyTranslucency410_g2185 = ( saturate( dotResult401_g2185 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA402_g2185 ).b );
				float TranslucencyIntensity72_g2185 = _TranslucencyPower;
				float4 Albedo_Output160_g2185 = ( ( _AlbedoColor * GrassColorVariation_Output109_g2185 ) * (1.0 + (TobyTranslucency410_g2185 - 0.0) * (TranslucencyIntensity72_g2185 - 1.0) / (1.0 - 0.0)) );
				
				float2 uv_NormalMap189_g2185 = packedInput.ase_texcoord5.xy;
				float3 unpack189_g2185 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap189_g2185 ), _NormalIntensity );
				unpack189_g2185.z = lerp( 1, unpack189_g2185.z, saturate(_NormalIntensity) );
				float3 Normal_Output154_g2185 = unpack189_g2185;
				float3 temp_output_4134_180 = Normal_Output154_g2185;
				
				float2 uv_MaskMapRGBA89_g2185 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode89_g2185 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA89_g2185 );
				float Smoothness_Output159_g2185 = ( tex2DNode89_g2185.a * _SmoothnessIntensity );
				
				float AoMapBase103_g2185 = tex2DNode89_g2185.g;
				float saferPower388_g2185 = abs( AoMapBase103_g2185 );
				float AmbientOcclusion_Output409_g2185 = ( pow( saferPower388_g2185 , _AmbientOcclusionIntensity ) * ( 1.5 / ( ( saturate( TobyTranslucency410_g2185 ) * TranslucencyIntensity72_g2185 ) + 1.5 ) ) );
				
				float2 uv_AlbedoMap86_g2185 = packedInput.ase_texcoord5.xy;
				float Opacity_Output155_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap86_g2185 ).a;
				
				float Thickness_Output415_g2185 = ( _ThicknessIntensity * ( 1.0 - tex2DNode89_g2185.b ) );
				
				float DiffusionProfile_Output420_g2185 = _DiffusionProfile;
				
				surfaceDescription.BaseColor = Albedo_Output160_g2185.rgb;
				surfaceDescription.Normal = temp_output_4134_180;
				surfaceDescription.BentNormal = temp_output_4134_180;
				...
				surfaceDescription.Smoothness = Smoothness_Output159_g2185;
				surfaceDescription.Occlusion = AmbientOcclusion_Output409_g2185;
				surfaceDescription.Alpha = Opacity_Output155_g2185;
				...
				#if defined(_HAS_REFRACTION) || defined(_MATERIAL_FEATURE_TRANSMISSION)
				surfaceDescription.Thickness = Thickness_Output415_g2185;
				#endif
				...
				#if defined( _MATERIAL_FEATURE_SUBSURFACE_SCATTERING ) || defined( _MATERIAL_FEATURE_TRANSMISSION )
				surfaceDescription.DiffusionProfile = DiffusionProfile_Output420_g2185;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap285_g2185 = packedInput.ase_texcoord2.xy;
				float2 uv_AlbedoMap295_g2185 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode295_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap295_g2185 );
				float2 uv_NoiseMapGrayscale302_g2185 = packedInput.ase_texcoord2.xy;
				float4 transform307_g2185 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform307_g2185.xyz = GetAbsolutePositionWS((transform307_g2185).xyz);
				float dotResult4_g2187 = dot( transform307_g2185.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2187 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2187 ) * 43758.55 ) ));
				float3 normalizeResult259_g2185 = normalize( packedInput.ase_texcoord3.xyz );
				float DryLeafPositionMask263_g2185 = ( (distance( normalizeResult259_g2185 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult294_g2185 = lerp( ( _DryLeafColor * ( tex2DNode295_g2185.g * 2 ) ) , tex2DNode295_g2185 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale302_g2185 ).r * lerpResult10_g2187 * DryLeafPositionMask263_g2185 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output311_g2185 = lerpResult294_g2185;
				Gradient gradient271_g2185 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g2186 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2186 ) * 43758.55 ) ));
				float4 lerpResult282_g2185 = lerp( SeasonControl_Output311_g2185 , ( ( SeasonControl_Output311_g2185 * 0.5 ) + ( SampleGradient( gradient271_g2185, lerpResult10_g2186 ) * SeasonControl_Output311_g2185 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA313_g2185 = packedInput.ase_texcoord2.xy;
				float4 lerpResult283_g2185 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap285_g2185 ) , lerpResult282_g2185 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA313_g2185 ).r ):( 1.0 )));
				float4 GrassColorVariation_Output109_g2185 = lerpResult283_g2185;
				float3 ase_worldPos = packedInput.ase_texcoord4.xyz;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float4 transform392_g2185 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord3.xyz , 0.0 ));
				transform392_g2185.xyz = GetAbsolutePositionWS((transform392_g2185).xyz);
				float dotResult401_g2185 = dot( float4( ase_worldViewDir , 0.0 ) , -( float4( SafeNormalize(-_DirectionalLightDatas[0].forward) , 0.0 ) + ( (( _TranslucencyTreeTangents )?( float4( packedInput.ase_normal , 0.0 ) ):( transform392_g2185 )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA402_g2185 = packedInput.ase_texcoord2.xy;
				float TobyTranslucency410_g2185 = ( saturate( dotResult401_g2185 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA402_g2185 ).b );
				float TranslucencyIntensity72_g2185 = _TranslucencyPower;
				float4 Albedo_Output160_g2185 = ( ( _AlbedoColor * GrassColorVariation_Output109_g2185 ) * (1.0 + (TobyTranslucency410_g2185 - 0.0) * (TranslucencyIntensity72_g2185 - 1.0) / (1.0 - 0.0)) );
				
				float2 uv_NormalMap189_g2185 = packedInput.ase_texcoord2.xy;
				float3 unpack189_g2185 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap189_g2185 ), _NormalIntensity );
				unpack189_g2185.z = lerp( 1, unpack189_g2185.z, saturate(_NormalIntensity) );
				float3 Normal_Output154_g2185 = unpack189_g2185;
				float3 temp_output_4134_180 = Normal_Output154_g2185;
				
				float2 uv_MaskMapRGBA89_g2185 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode89_g2185 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA89_g2185 );
				float Smoothness_Output159_g2185 = ( tex2DNode89_g2185.a * _SmoothnessIntensity );
				...
				float2 uv_AlbedoMap86_g2185 = packedInput.ase_texcoord2.xy;
				float Opacity_Output155_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap86_g2185 ).a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_AlbedoMap86_g2185 = packedInput.ase_texcoord1.xy;
				float Opacity_Output155_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap86_g2185 ).a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_NormalMap189_g2185 = packedInput.ase_texcoord3.xy;
				float3 unpack189_g2185 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap189_g2185 ), _NormalIntensity );
				unpack189_g2185.z = lerp( 1, unpack189_g2185.z, saturate(_NormalIntensity) );
				float3 Normal_Output154_g2185 = unpack189_g2185;
				float3 temp_output_4134_180 = Normal_Output154_g2185;
				
				float2 uv_MaskMapRGBA89_g2185 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode89_g2185 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA89_g2185 );
				float Smoothness_Output159_g2185 = ( tex2DNode89_g2185.a * _SmoothnessIntensity );
				
				float2 uv_AlbedoMap86_g2185 = packedInput.ase_texcoord3.xy;
				float Opacity_Output155_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap86_g2185 ).a;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoMap285_g2185 = packedInput.ase_texcoord7.xy;
				float2 uv_AlbedoMap295_g2185 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode295_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap295_g2185 );
				float2 uv_NoiseMapGrayscale302_g2185 = packedInput.ase_texcoord7.xy;
				float4 transform307_g2185 = mul(GetObjectToWorldMatrix(),float4( 1,1,1,1 ));
				transform307_g2185.xyz = GetAbsolutePositionWS((transform307_g2185).xyz);
				float dotResult4_g2187 = dot( transform307_g2185.xy , float2( 12.9898,78.233 ) );
				float lerpResult10_g2187 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2187 ) * 43758.55 ) ));
				float3 normalizeResult259_g2185 = normalize( packedInput.ase_texcoord8.xyz );
				float DryLeafPositionMask263_g2185 = ( (distance( normalizeResult259_g2185 , float3( 0,0.8,0 ) )*1.0 + 0.0) * 1 );
				float4 lerpResult294_g2185 = lerp( ( _DryLeafColor * ( tex2DNode295_g2185.g * 2 ) ) , tex2DNode295_g2185 , saturate( (( ( tex2D( _NoiseMapGrayscale, uv_NoiseMapGrayscale302_g2185 ).r * lerpResult10_g2187 * DryLeafPositionMask263_g2185 ) - _SeasonChangeGlobal )*_DryLeavesScale + _DryLeavesOffset) ));
				float4 SeasonControl_Output311_g2185 = lerpResult294_g2185;
				Gradient gradient271_g2185 = NewGradient( 0, 2, 2, float4( 1, 0.276868, 0, 0 ), float4( 0, 1, 0.7818019, 1 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				...
				float lerpResult10_g2186 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g2186 ) * 43758.55 ) ));
				float4 lerpResult282_g2185 = lerp( SeasonControl_Output311_g2185 , ( ( SeasonControl_Output311_g2185 * 0.5 ) + ( SampleGradient( gradient271_g2185, lerpResult10_g2186 ) * SeasonControl_Output311_g2185 ) ) , _ColorVariation);
				float2 uv_MaskMapRGBA313_g2185 = packedInput.ase_texcoord7.xy;
				float4 lerpResult283_g2185 = lerp( tex2D( _AlbedoMap, uv_AlbedoMap285_g2185 ) , lerpResult282_g2185 , (( _BranchMaskR )?( tex2D( _MaskMapRGBA, uv_MaskMapRGBA313_g2185 ).r ):( 1.0 )));
				float4 GrassColorVariation_Output109_g2185 = lerpResult283_g2185;
				float4 transform392_g2185 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord8.xyz , 0.0 ));
				transform392_g2185.xyz = GetAbsolutePositionWS((transform392_g2185).xyz);
				float dotResult401_g2185 = dot( float4( V , 0.0 ) , -( float4( SafeNormalize(-_DirectionalLightDatas[0].forward) , 0.0 ) + ( (( _TranslucencyTreeTangents )?( float4( packedInput.ase_normal , 0.0 ) ):( transform392_g2185 )) * _TranslucencyRange ) ) );
				float2 uv_MaskMapRGBA402_g2185 = packedInput.ase_texcoord7.xy;
				float TobyTranslucency410_g2185 = ( saturate( dotResult401_g2185 ) * tex2D( _MaskMapRGBA, uv_MaskMapRGBA402_g2185 ).b );
				float TranslucencyIntensity72_g2185 = _TranslucencyPower;
				float4 Albedo_Output160_g2185 = ( ( _AlbedoColor * GrassColorVariation_Output109_g2185 ) * (1.0 + (TobyTranslucency410_g2185 - 0.0) * (TranslucencyIntensity72_g2185 - 1.0) / (1.0 - 0.0)) );
				
				float2 uv_NormalMap189_g2185 = packedInput.ase_texcoord7.xy;
				float3 unpack189_g2185 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap189_g2185 ), _NormalIntensity );
				unpack189_g2185.z = lerp( 1, unpack189_g2185.z, saturate(_NormalIntensity) );
				float3 Normal_Output154_g2185 = unpack189_g2185;
				float3 temp_output_4134_180 = Normal_Output154_g2185;
				
				float2 uv_MaskMapRGBA89_g2185 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode89_g2185 = tex2D( _MaskMapRGBA, uv_MaskMapRGBA89_g2185 );
				float Smoothness_Output159_g2185 = ( tex2DNode89_g2185.a * _SmoothnessIntensity );
				...
				float2 uv_AlbedoMap86_g2185 = packedInput.ase_texcoord7.xy;
				float Opacity_Output155_g2185 = tex2D( _AlbedoMap, uv_AlbedoMap86_g2185 ).a;
