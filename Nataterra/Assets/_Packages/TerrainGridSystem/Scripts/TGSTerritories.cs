...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        public int TerritoryGetFrontierVertices (int territoryIndex, List<Vector2> vertices, int regionIndex = -1, bool includeGridEdges = false) {
            return TerritoryGetFrontierVertices(territoryIndex, -1, vertices, regionIndex, includeGridEdges);
        }
        ...
        public int TerritoryGetFrontierVertices (int territoryIndex, int otherTerritoryIndex, List<Vector2> vertices, int regionIndex = -1, bool includeGridEdges = false) {
