...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        void BuildOrderedFrontierVertices (Vector3[] vertices) {
            BuildOrderedFrontierVertices((IList<Vector3>)vertices);
        }

        void BuildOrderedFrontierVertices (List<Vector3> vertices) {
            BuildOrderedFrontierVertices((IList<Vector3>)vertices);
        }

        void BuildOrderedFrontierVertices (IList<Vector3> vertices) {
